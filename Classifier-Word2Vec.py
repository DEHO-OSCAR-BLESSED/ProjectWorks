...
tweet_files = ['US_2018-03-22.json','US_2018-03-25.json','US_2018-03-23.json','US_2018-03-26.json','US_2018-03-27.json'] #list of files     'negative_tweets.json', 'positive_tweets.json', 'negative_tweets.json'   'US_2018-03-22.json','US_2018-03-25.json','US_2018-03-23.json','US_2018-03-26.json','US_2018-03-27.json','US_2018-03-28.json'
tweets_data = []
...
def plot_confusion_matrix(cm, classes,
    ...
    new = np.sum(cm,axis=0)
    labels = 'Positive', 'Neutral', 'Negative'
    explode=(0,0,0.1)
    size = new.tolist()


    plt.pie(size,labels=labels,autopct='%1.1f%%',shadow=True,startangle=140,explode=explode)
    plt.axis('equal')
    plt.title(" Sentiment analysis of US Military Base in Ghana")
    plt.show()
    #print(size)
